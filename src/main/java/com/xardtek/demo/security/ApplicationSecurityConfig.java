...
import com.xardtek.demo.jwt.JwtConfig;
import com.xardtek.demo.jwt.JwtTokenVerifier;
import com.xardtek.demo.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //Add  line of code if you want to use code level annotation !
